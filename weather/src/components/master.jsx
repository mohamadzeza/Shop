        ...
        <div className="flex items-center justify-center mt-5">
         <div className=" w-[400px] h-64 rounded-2xl flex items-start justify-between bg-blue-500 p-10">
            <div className="flex flex-col justify-center mt-4 gap-y-5">
                ...
                <button className="border border-[1.5px] border-blue-700 rounded-md p-1.5 text-blue-700 text-sm hover:text-white hover:bg-blue-700 transition-colors " onClick={handlesearch2} >Fahrenheit</button>
                <button className="border border-[1.5px] border-blue-700 rounded-md p-1.5 text-blue-700 text-sm hover:text-white hover:bg-blue-700  " onClick={handlesearch}>Celsius</button>
                </div>
                <div>
                </div>
            </div>
            <div className="flex flex-col justify-center">
                ...
                <h2 className="ml-4 text-3xl text-white">{Dataweather && Dataweather.main.temp}C</h2>
            </div>
